...
export default function DeleteButton({
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      await deleteProductAction(
        productId,
        hasOrders ? reason.trim() : "ลบสินค้า — ไม่มีคำสั่งซื้อ",
      );
      showSuccessToast(
        hasOrders ? "ยกเลิกการขายสินค้าเรียบร้อยแล้ว" : "ลบสินค้าเรียบร้อยแล้ว",
      );
      router.push("/stores");
    } catch (err: any) {
  ...
  return (
    <>
      ...
      >
        <Trash2 size={16} />
        {hasOrders ? "ยกเลิกการขาย" : "ลบสินค้า"}
      </button>
            ...
            <div className="relative bg-[#1e1b3d] border border-[#262549] rounded-3xl p-6 max-w-lg w-full shadow-2xl overflow-hidden">
              ...
              <div className="text-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-white mb-2">
                  {hasOrders ? "ยกเลิกการขายสินค้า" : "ลบสินค้า"}
                </h3>
              ...
              <div className="flex gap-3">
                ...
                >
                  {isDeleting ? (
                    ...
                    <>
                      <Trash2 size={16} />
                      {hasOrders ? "ยืนยันยกเลิกการขาย" : "ยืนยันลบสินค้า"}
                    </>
                  )}
                </button>
              </div>
